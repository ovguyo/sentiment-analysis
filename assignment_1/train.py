...
class_counts = np.array([370, 488, 15])
total = 873
...
if init_from == 'scratch':
    ...
    model = GPT(gptconf, num_classes=num_classes, class_weights=class_weights)
    ...
    model = GPT.from_pretrained(init_from, num_classes, class_weights, override_args)
